...
return [
	...
	| utilisés par la classe validateur. Certaines de ces règles ont plusieurs versions
	| comme les règles de taille. N'hésitez pas à les ajuster selon vos besoins.
	|
	*/
	...
	'ascii' => 'Le champ :attribute ne peut contenir que des caractères alphanumériques et des symboles en octet unique.',
	...
	*/
	...
	|--------------------------------------------------------------------------
	|
	| Les lignes suivantes sont utilisées pour remplacer les espaces réservés par
	| des termes plus conviviaux tels que "Adresse E-Mail" au lieu de "email".
	| Cela nous aide à rendre le message plus expressif.
	|
	*/
